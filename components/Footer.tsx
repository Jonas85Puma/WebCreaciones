        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/profile.php?id=61585978985663" target="_blank" rel="noopener noreferrer" aria-label="Visitar Facebook" className="w-10 h-10 bg-neutral-700 dark:bg-neutral-800 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-colors">
