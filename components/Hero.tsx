...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-[calc(100svh-4rem)] md:h-[calc(100vh-4rem)] md:min-h-0 flex items-center justify-center bg-linear-to-br from-slate-50 via-white to-blue-50 dark:from-black dark:via-black dark:to-black overflow-hidden">
      ...
      <div className="hidden md:block absolute top-20 -left-40 w-96 h-96 bg-blue-400/10 dark:bg-blue-500/10 rounded-full blur-3xl" aria-hidden="true" />
      <div className="hidden md:block absolute bottom-20 -right-40 w-96 h-96 bg-purple-400/10 dark:bg-purple-500/10 rounded-full blur-3xl" aria-hidden="true" />
      ...
      {/* Overlay - SIN blur en móvil para mejor rendimiento */}
      <div className="absolute inset-0 bg-white/70 dark:bg-black/80 md:backdrop-blur-[2px]" aria-hidden="true" />
      
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-4 md:space-y-6 lg:space-y-8">
          {/* Badge */}
          <div className="flex justify-center">
            <Badge variant="secondary" className="inline-flex items-center gap-2 bg-blue-100/90 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-4 py-2 text-xs sm:text-sm font-medium">
